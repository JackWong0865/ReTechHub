...
<head>
    ...
    <link rel="stylesheet"
    href="../assets/css/technician.css">

    <link rel="stylesheet"
    href="../assets/css/assigned-repairs.css">
    ...
    <main class="tech-main">
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <p>
                    Manage all repair requests assigned to you.
                </p>
        ...
        <div class="repair-grid">
                ...
                <div class="repair-card">
                    ...
                    <form method="POST" class="repair-actions">
                        ...
                        <select name="status">
                            ...
                            <option
                            value="Workshop Repair"
                            <?= $r['status']=='Workshop Repair'?'selected':''; ?>>
                                Workshop Repair
                            </option>
                    ...
                    <a href="repair-detail.php?id=<?= $r['booking_id']; ?>&from=assigned"
            ...
            <?php }else{ ?>
                ...
                <div class="empty-box">
                    ...
                    <p>
                        You currently have no assigned repairs.
                    </p>
