...
<html>
    <head>
        <title>Admin Messages - ReTech Hub</title>
    ...
    <body>
        ...
        <div class="admin-layout">
            ...
            <aside class="sidebar">
                ...
                <a href="messages.php" class="active"><i class="fa-solid fa-message"></i>Messages</a>
                ...
                <div class="message-layout message-inside-dashboard">
                    ...
                    <div class="chat-sidebar">
                        ...
                        <div class="chat-sidebar-top">
                            ...
                            <a href="admin.php" class="back-message-btn">
                        ...
                        <!--display user at the message side bar-->
        ...
        <!--chatbox display, emoji, image, image box function, automatic reload message side bar and open picture-->
        <script>
