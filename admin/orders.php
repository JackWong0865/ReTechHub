...
if(isset($_POST['update_status'])){
    ...
    $_SESSION['order_status_success'] = "Order #ORD$order_id status updated to $status successfully.";
                        ...
                        <?php if(mysqli_num_rows($orders) > 0){ ?>
                            ...
                            <?php while($o = mysqli_fetch_assoc($orders)){ ?>
                                ...
                                <tr>
                                    ...
                                    <td> <b>RM<?= number_format($o['total_amount'], 2); ?></b> </td>
                                    ...
                                    <td class="order-actions">
                                        ...
                                        <a href="order-detail.php?id=<?= $o['order_id']; ?>" class="view-btn">
                                            View
                                        </a>
