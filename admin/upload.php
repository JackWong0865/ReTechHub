...
if(isset($_POST['save_draft']) || isset($_POST['publish'])){
    ...
    */
    if($is_publish){
        ...
        if(
            ...
            $error =
                "Please complete all required product details before publishing.";
        }
        elseif(!is_numeric($price) || (float)$price <= 0){

            $error =
                "Product price must be greater than RM0.";
        ...
        elseif(
            ...
            $error =
                "Product stock must be at least 1.";
    ...
    */
    if($is_draft){
        ...
        if($product_name === ""){
            ...
            $error =
                "Please enter a product name before saving the draft.";

        }
        elseif($completed_fields < 2){

            $error =
                "Please complete at least two additional product fields before saving the draft.";
        }
    }
    ...
    */
    if($error === ""){
        ...
        $condition_db =
            mysqli_real_escape_string($conn, $condition);
        ...
        $storage_db =
            mysqli_real_escape_string($conn, $storage);
        ...
        $network_db =
            mysqli_real_escape_string($conn, $network);
