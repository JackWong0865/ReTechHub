        ...
        <div class="admin-layout">
            ...
            <main class="admin-main">
                ...
                <div class="search-page">
                    ...
                    <h1 class="search-title"> Search Results for “<?= htmlspecialchars($q); ?>” </h1>
                    ...
                    <div class="search-card">
                        ...
                        <?php if(mysqli_num_rows($products) > 0){ ?>
                            ...
                            <?php while($p = mysqli_fetch_assoc($products)){ ?>
                                ...
                                <a href="view-product.php?id=<?= $p['product_id']; ?>" class="result-row">
                    ...
                    <div class="search-card">
                        ...
                        <?php if(mysqli_num_rows($orders) > 0){ ?>
                            ...
                            <?php while($o = mysqli_fetch_assoc($orders)){ ?>
                                ...
                                <a href="order-detail.php?id=<?= $o['order_id']; ?>" class="result-row">
                    ...
                    <div class="search-card">
                        ...
                        <?php if(mysqli_num_rows($repairs) > 0){ ?>
                            ...
                            <?php while($r = mysqli_fetch_assoc($repairs)){ ?>
                                ...
                                <a href="booking-detail.php?type=repair&id=<?= $r['booking_id']; ?>" class="result-row">
                    ...
                    <div class="search-card">
                        ...
                        <?php if(mysqli_num_rows($sells) > 0){ ?>
                            ...
                            <?php while($s = mysqli_fetch_assoc($sells)){ ?>
                                ...
                                <a href="booking-detail.php?type=sell&id=<?= $s['sell_id']; ?>" class="result-row">
