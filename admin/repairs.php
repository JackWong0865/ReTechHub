                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <!--action button-->
                            <a
                            href="booking-detail.php?type=repair&id=<?= $r['id']; ?>"
                            class="small-btn red">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="action-cell">
                            ...
                            <!--action button-->
                            <a
                            href="booking-detail.php?type=sell&id=<?= $s['id']; ?>"
                            class="small-btn red">
...
function showBookingTab(type){
    ...
    const repairTab =
        document.getElementById("repairTab");

    const sellTab =
        document.getElementById("sellTab");

    const repairHistoryTab =
        document.getElementById("repairHistoryTab");

    const sellHistoryTab =
        document.getElementById("sellHistoryTab");
